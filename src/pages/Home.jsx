      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-md border-b border-slate-200 text-navy-900' : inHero ? 'bg-[#FAF9F5]/85 backdrop-blur-md border-b border-slate-100 text-navy-900' : 'bg-navy-950/95 backdrop-blur-md shadow-lg border-b border-navy-900 text-white'}`}>
        <div className="max-w-content mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="https://calendly.com/chandru-theatpass/discovery-call" target="_blank" rel="noopener noreferrer" className="hidden md:block bg-gold-500 hover:bg-gold-600 text-navy-950 px-6 py-2.5 rounded-full font-bold transition-all hover:shadow-lg hover:shadow-gold-500/20 hover:-translate-y-0.5">
        ...
        <div className={`md:hidden overflow-hidden transition-all duration-300 ${mobileMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
          <div className={`px-6 py-4 border-t ${scrolled || inHero ? 'bg-white border-slate-200 text-navy-900' : 'bg-navy-950 border-navy-900 text-white'} space-y-4`}>
            ...
            <a href="https://calendly.com/chandru-theatpass/discovery-call" target="_blank" rel="noopener noreferrer" onClick={() => setMobileMenuOpen(false)} className="block w-full bg-gold-500 hover:bg-gold-600 text-navy-950 px-6 py-3 rounded-full font-bold transition-all text-center">
              Book a Strategy Call
            </a>
          </div>
        </div>
        ...
        <div className="max-w-content mx-auto px-6 relative z-10">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              ...
              <a href="https://calendly.com/chandru-theatpass/discovery-call" target="_blank" rel="noopener noreferrer" className="inline-block bg-white text-navy-950 hover:bg-gold-50 hover:text-gold-700 px-6 py-3 rounded-full font-bold transition-all hover:shadow-lg hover:-translate-y-0.5 border border-slate-200">
                Book a Strategy Call
              </a>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 font-medium">
                ...
                <li><a href="https://calendly.com/chandru-theatpass/discovery-call" target="_blank" rel="noopener noreferrer" className="hover:text-gold-400 transition-colors">Book a Call</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm font-medium">
              ...
              <a href="/terms-and-conditions" className="hover:text-gold-400 transition-colors">Terms of Service</a>
            </div>
          </div>
        </div>
      </footer>
